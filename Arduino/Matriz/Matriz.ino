...
String generarCadena(String frase)
{
    ...
    for (int i = 0; i < frase.length(); i++)
    {
        ...
        {
            cadena += "020050088104202";
        }
        else if (frase[i] == '>')
        {
            cadena += "202104088050020";
        }
        else if (frase[i] == '_')
        {
            cadena += "001001001001001";
        }
        else if (frase[i] == '$')
        {
            cadena += "0CC1223FF1120CC";
        }
        else if (frase[i] == '¿')
        {
            cadena += "00E0112E1001006";
        }
        else if (frase[i] == '¡')
        {
            cadena += "2FF";
        ...
        {
            cadena += "3FF201201201201";
        }
        else if (frase[i] == ']')
        {
            cadena += "2012012012013FF";
        }
        else if (frase[i] == '|')
        {
            cadena += "2FF";
        ...
        {
            cadena += "002004002002004";
        }
        else if (frase[i] == '\\')
        {
            cadena += "3000C003000C003";
        }
        else if (frase[i] == '\'')
        {
            cadena += "1C0";
        ...
        {
            cadena += "0001C00001C0000";
        }
        else if (frase[i] == '@')
        {
            cadena += "1FF1111291FD001";
        }
        else if (frase[i] == '¡')
        {
            cadena += "2FF";
        ...
        {
            cadena += "2012011EE010000";
        }
        else if (frase[i] == '{')
        {
            cadena += "0000101EE201201";
        }
        else
        {
